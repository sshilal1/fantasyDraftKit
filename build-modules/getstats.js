...
var teamFileString = 'local-storage/teams/' + team + '-team.json';
const teamStatsDir = 'local-storage/stats/' + team;
if (!fs.existsSync(teamStatsDir)) {
	fs.mkdirSync(teamStatsDir);
}

var teamData = JSON.parse(fs.readFileSync(teamFileString, 'utf8'));
